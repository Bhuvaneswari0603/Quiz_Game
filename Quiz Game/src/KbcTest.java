...
JLabel lb1,lb2;
ButtonGroup bg;
String ques[]={"who developed java?","Which one is the feature of java?","Java developed in the year?"};
String op1[]={"Tim","robust","1990",};
String op2[]={"steve","Inheritance","1998"};
String op3[]={"mark","secure","1995"};
String op4[]={"james","multithread","1993"};
String ans[]={"james","Inheritance","1995"};
int cn;
KbcTest()
{
fr=new JFrame();
